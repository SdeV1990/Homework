...
// Object with state of authorization and functions of signIn and signOut
const fakeAuth = {
...
// Create object with user state, functions of sign in and sign out
...
function AuthButton() {
  ...
  let auth = useAuth(); //Using context
